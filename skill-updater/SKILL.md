...
- `python3 scripts/update_skills.py --dry-run --allow-manual-map --source-map ./config/skills_source_map.json`

3. Apply updates.
- `python3 scripts/update_skills.py --allow-manual-map --source-map ./config/skills_source_map.json`
